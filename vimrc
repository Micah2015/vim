...
let g:ycm_global_ycm_extra_conf = '/home/micahubuntu14/.ycm_global_ycm_extra_conf'
...
"Micah first time: 20160308 
"输好函数参数后的括号匹配
" imap <F2> )<Enter>{<Enter><Enter><Esc>ki<Tab>
"快速增加函数注释
" nmap <F3> O<Home>/****************************************<CR>Name:  <CR>Funtion:  <CR>Input:  <CR>Output:  <CR>Global Var:  <CR><BS><BS><BS>****************************************/<Esc>
"Cscope配置"{{{1
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
if has("cscope")
...
function CscopeRefresh()
    "被下面的替换 本句为c 下句为包含c++
    execute "!cscope -Rbq"
    " execute "!echo 'abc' >> t.txt"
    "Micah c++ 
    "execute "!find ./ -name '*.c' -o -name '*.cpp' -o -name '*.h' &gt;cscope.files"
